...
sub makeGraphInputs {
    ...
    webpage::makeTextBoxInput( $cgi, 'xmax', '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Frequency Stop [Hz]: ',
        4, 160e6 );
    print '<br>';
...
sub DownloadFiles {
    ...
    print '<br><br>';
    print $cgi->a( { href => ( 'http://www.srs.is.keysight.com/~anferrar/tmp/' . $filename ) },
        "Right-Click, Save Link As... To Save Data" );

}

sub makeForm_WebpageHeaderAndyStyle {
    my $cgi          = shift;
    my $formpath     = shift;
    my $TabTitle     = shift;
    my $WebpageTitle = shift;

    my $host = hostname;

    print "Content-type: text/html\n\n";
    print $cgi->start_html($TabTitle);           ## This is the Tab Tile
    print $cgi->a( { href => ( "http://" . $host . "/" ) }, "Return Home" );
    print "<H2>" . $WebpageTitle . "</H2>\n";    ## This is the Page Title
